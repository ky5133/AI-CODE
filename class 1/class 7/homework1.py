import cv2
image=cv2.imread(r"C:/Users/Dinesh Bachani/Downloads/PNG_transparency_demonstration_1.png")
...
if key == ord('w'):
    resized_image=cv2.resize(gray_image,(324,324))
else:
    print("Same size image")        
